...
//** MANEIRA ALTERNATIVA, TAMBÉM FUNCIONA.
//        ArvoreBinaria<E> resultado = null;
//        if (inicio) {
//            reinicia();
//            inicio = false;
//        }
//        if (!(fila.isEmpty() && pilha.isEmpty()) || ultimoVisitado != null) {
//            while (ultimoVisitado != null) {
    ...
    public ArvoreBinaria<E> proximoPosOrdem() {
        ...
        while (!pilha.isEmpty() || ultimoVisitado != null) {
            if (ultimoVisitado != null) {
                ...
                noPos = pilha.peek();
                // se ramo direito existe e o nó está sendo percorrido pela esquerda, vamos para a direita
                if (noPos.direita != null && lastNo != noPos.direita) {
